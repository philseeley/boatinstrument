...
if [ "$LMARCH" == 'armhf' ]; then
  ...
  wget https://gsdview.appspot.com/dart-archive/channels/stable/release/3.4.3/sdk/dartsdk-linux-arm-release.zip
  unzip dartsdk-linux-arm-release.zip
  ./dart-sdk/bin/dart --version
  export PATH="$PATH:`pwd`/dart-sdk/bin"
fi

git clone --depth 1 --branch 3.22.2 https://github.com/flutter/flutter
