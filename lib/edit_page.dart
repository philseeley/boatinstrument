...
final List<BoxDetails> boxDetails = [
  ...
  BoxDetails(WindVoltageBox.sid, (config) {return WindVoltageBox.fromSettings(config, key: UniqueKey());}),
  BoxDetails(WindCurrentBox.sid, (config) {return WindCurrentBox.fromSettings(config, key: UniqueKey());}),
  ...
  BoxDetails(WindPowerGraph.sid, graph: true, background: (ctrl, _) => WindPowerGraphBackground(controller: ctrl), (config) {return WindPowerGraph.fromSettings(config, key: UniqueKey());}),
  ...
  List<PopupMenuEntry<BoxDetails>> _getWidgetMenus(_Box box) {
    List<PopupMenuEntry<BoxDetails>> popupMenuEntries = [
      ...
      _widgetSubMenuEntry(box, 'Electrical', [
        ...
        _widgetSubMenuEntry(box, 'Wind Generator', [
