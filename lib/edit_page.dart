...
final List<BoxDetails> boxDetails = [
  ...
  BoxDetails(TrueWindDirectionGraph.sid, graph: true, background: (ctrl) {TrueWindDirectionGraphBackground(controller: ctrl);}, (config) {return TrueWindDirectionGraph(config, key: UniqueKey());}),
  ...
  BoxDetails(ApparentWindAngleGraph.sid, graph: true, background: (ctrl) {ApparentWindAngleGraphBackground(controller: ctrl);}, (config) {return ApparentWindAngleGraph(config, key: UniqueKey());}),
  ...
  BoxDetails(BatteryPowerGraph.sid, graph: true, background: (ctrl) {BatteryPowerGraphBackground(controller: ctrl);}, (config) {return BatteryPowerGraph.fromSettings(config, key: UniqueKey());}),
  BoxDetails(SolarPowerGraph.sid, graph: true, background: (ctrl) {SolarPowerGraphBackground(controller: ctrl);}, (config) {return SolarPowerGraph.fromSettings(config, key: UniqueKey());}),
