...
final List<BoxDetails> boxDetails = [
  ...
  BoxDetails(VoltMeterBox.sid, 'Volt Meter', true, (config) {return VoltMeterBox.fromSettings(config, key: UniqueKey());}),
  BoxDetails(VoltageBox.sid, 'Voltage', false, (config) {return VoltageBox.fromSettings(config, key: UniqueKey());}),
  ...
  _getWidgetMenus(_Box box) {
    List<PopupMenuEntry<BoxDetails>> popupMenuEntries = [
      ...
      _widgetSubMenuEntry(box, 'Electrical', [
        ...
        _widgetMenuEntry(VoltageBox.sid),
        ]),
