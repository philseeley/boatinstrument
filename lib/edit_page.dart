...
final List<BoxDetails> boxDetails = [
  ...
  BoxDetails(MinDepthBelowSurfaceBox.sid, 'Min Depth', (config) {return MinDepthBelowSurfaceBox(config, key: UniqueKey());}),
  BoxDetails(DepthBelowKeelBox.sid, 'Depth Below Keel', (config) {return DepthBelowKeelBox(config, key: UniqueKey());}),
  BoxDetails(MinDepthBelowKeelBox.sid, 'Min DBK', (config) {return MinDepthBelowKeelBox(config, key: UniqueKey());}),
  BoxDetails(DepthBelowTransducerBox.sid, 'Depth Below Transducer', (config) {return DepthBelowTransducerBox(config, key: UniqueKey());}),
  BoxDetails(MinDepthBelowTransducerBox.sid, 'Min DBT', (config) {return MinDepthBelowTransducerBox(config, key: UniqueKey());}),
  BoxDetails(SpeedThroughWaterBox.sid, 'Speed Through Water', (config) {return SpeedThroughWaterBox(config, key: UniqueKey());}),
  BoxDetails(MaxSpeedThroughWaterBox.sid, 'Max Speed', (config) {return MaxSpeedThroughWaterBox(config, key: UniqueKey());}),
  BoxDetails(SpeedOverGroundBox.sid, 'Speed Over Ground', (config) {return SpeedOverGroundBox(config, key: UniqueKey());}),
  BoxDetails(MaxSpeedOverGroundBox.sid, 'Max SOG', (config) {return MaxSpeedOverGroundBox(config, key: UniqueKey());}),
  BoxDetails(WindSpeedApparentBox.sid, 'Wind Speed Apparent', (config) {return WindSpeedApparentBox(config, key: UniqueKey());}),
  BoxDetails(MaxWindSpeedApparentBox.sid, 'Max AWS', (config) {return MaxWindSpeedApparentBox(config, key: UniqueKey());}),
  BoxDetails(WindSpeedTrueBox.sid, 'Wind Speed True', (config) {return WindSpeedTrueBox(config, key: UniqueKey());}),
  BoxDetails(MaxWindSpeedTrueBox.sid, 'Max TWS', (config) {return MaxWindSpeedTrueBox(config, key: UniqueKey());}),
  ...
  _getWidgetMenus(_Box box) {
    List<PopupMenuEntry<BoxDetails>> popupMenuEntries = [
      ...
      _widgetSubMenuEntry(box, 'Navigation', [
        ...
        _widgetMenuEntry(MaxSpeedOverGroundBox.sid),
      ...
      _widgetSubMenuEntry(box, 'Boat', [
        ...
        _widgetMenuEntry(MaxSpeedThroughWaterBox.sid),
      ...
      _widgetSubMenuEntry(box, 'Wind', [
        ...
        _widgetMenuEntry(MaxWindSpeedApparentBox.sid),
        ...
        _widgetMenuEntry(MaxWindSpeedTrueBox.sid),
