...
List<BoxDetails> boxDetails = [
  ...
  BoxDetails(AutopilotStateControlBox.sid, 'Autopilot State Control', (config) {return AutopilotStateControlBox(config, key: UniqueKey());}),
  ...
  _getWidgetMenus(_Box box) {
    List<PopupMenuEntry<BoxDetails>> popupMenuEntries = [
      ...
      _widgetSubMenuEntry(box, 'Autopilot', [
        ...
        _widgetMenuEntry(AutopilotStateControlBox.sid),
