...
final List<BoxDetails> boxDetails = [
  ...
  BoxDetails(WebViewBox.sid, experimental: true, deprecatedDate: DateTime(2026, 07), (config) {return WebViewBox(config, key: UniqueKey());}),
  ...
  BoxDetails(ChargerVoltageBox.sid, (config) {return ChargerVoltageBox.fromSettings(config, key: UniqueKey());}),
  BoxDetails(ChargerCurrentBox.sid, (config) {return ChargerCurrentBox.fromSettings(config, key: UniqueKey());}),
  ...
  BoxDetails(TrueWindSpeedGraph.sid, graph: true, background: (ctrl, _) => TrueWindSpeedGraphBackground(controller: ctrl), (config) {return TrueWindSpeedGraph(config, key: UniqueKey());}),
  BoxDetails(TrueWindDirectionGraph.sid, graph: true, background: (ctrl, _) => TrueWindDirectionGraphBackground(controller: ctrl), (config) {return TrueWindDirectionGraph(config, key: UniqueKey());}),
  BoxDetails(ApparentWindSpeedGraph.sid, graph: true, background: (ctrl, _) => ApparentWindSpeedGraphBackground(controller: ctrl), (config) {return ApparentWindSpeedGraph(config, key: UniqueKey());}),
  BoxDetails(ApparentWindAngleGraph.sid, graph: true, background: (ctrl, _) => ApparentWindAngleGraphBackground(controller: ctrl), (config) {return ApparentWindAngleGraph(config, key: UniqueKey());}),
  BoxDetails(WaterTemperatureGraph.sid, graph: true, background: (ctrl, _) => WaterTemperatureGraphBackground(controller: ctrl), (config) {return WaterTemperatureGraph(config, key: UniqueKey());}),
  BoxDetails(SpeedThroughWaterGraph.sid, graph: true, background: (ctrl, _) => SpeedThroughWaterGraphBackground(controller: ctrl), (config) {return SpeedThroughWaterGraph(config, key: UniqueKey());}),
  BoxDetails(SpeedOverGroundGraph.sid, graph: true, background: (ctrl, _) => SpeedOverGroundGraphBackground(controller: ctrl), (config) {return SpeedOverGroundGraph(config, key: UniqueKey());}),
  BoxDetails(OutsidePressureGraph.sid, graph: true, background: (ctrl, _) => OutsidePressureGraphBackground(controller: ctrl), (config) {return OutsidePressureGraph(config, key: UniqueKey());}),
  BoxDetails(OutsideTemperatureGraph.sid, graph: true, background: (ctrl, _) => OutsideTemperatureGraphBackground(controller: ctrl), (config) {return OutsideTemperatureGraph(config, key: UniqueKey());}),
  BoxDetails(VNCBox.sid, experimental: true, (config) {return VNCBox(config, key: UniqueKey());}),
  BoxDetails(CrossTrackErrorGraph.sid, graph: true, background: (ctrl, _) => CrossTrackErrorGraphBackground(controller: ctrl), (config) {return CrossTrackErrorGraph(config, key: UniqueKey());}),
  BoxDetails(DepthBelowSurfaceGraph.sid, graph: true, background: (ctrl, _) => DepthBelowSurfaceGraphBackground(controller: ctrl), (config) {return DepthBelowSurfaceGraph(config, key: UniqueKey());}),
  BoxDetails(DepthBelowKeelGraph.sid, graph: true, background: (ctrl, _) => DepthBelowKeelGraphBackground(controller: ctrl), (config) {return DepthBelowKeelGraph(config, key: UniqueKey());}),
  BoxDetails(DepthBelowTransducerGraph.sid, graph: true, background: (ctrl, _) => DepthBelowTransducerGraphBackground(controller: ctrl), (config) {return DepthBelowTransducerGraph(config, key: UniqueKey());}),
  ...
  BoxDetails(BatteryPowerGraph.sid, graph: true, background: (ctrl, _) => BatteryPowerGraphBackground(controller: ctrl), (config) {return BatteryPowerGraph.fromSettings(config, key: UniqueKey());}),
  BoxDetails(SolarPowerGraph.sid, graph: true, background: (ctrl, _) => SolarPowerGraphBackground(controller: ctrl), (config) {return SolarPowerGraph.fromSettings(config, key: UniqueKey());}),
  BoxDetails(ChargerPowerGraph.sid, graph: true, background: (ctrl, _) => ChargerPowerGraphBackground(controller: ctrl), (config) {return ChargerPowerGraph.fromSettings(config, key: UniqueKey());}),
  ...
  BoxDetails(TimerDisplayBox.sid, background: (ctrl, settings) => TimerBackgroundTask(ctrl, settings), (config) {return TimerDisplayBox(config, key: UniqueKey());}),
    ...
    List<PopupMenuEntry<BoxDetails>> popupMenuEntries = [
      ...
      _widgetSubMenuEntry(box, 'Wind', [
        _widgetSubMenuEntry(box, 'Apparent Wind', [
          ...
          _widgetMenuEntry(ApparentWindAngleGraph.sid, 'Angle'),
        ]),
        _widgetSubMenuEntry(box, 'True Wind', [
          ...
          _widgetMenuEntry(TrueWindDirectionGraph.sid, 'Direction'),
      ...
      _widgetSubMenuEntry(box, 'Electrical', [
        ...
        _widgetSubMenuEntry(box, 'Charger', [
          _widgetMenuEntry(ChargerVoltageBox.sid, 'Voltage'),
          _widgetMenuEntry(ChargerCurrentBox.sid, 'Current'),
          _widgetMenuEntry(ChargerPowerGraph.sid, 'Power'),
        ]),
