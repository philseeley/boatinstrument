...
_SignalKServerSettings _$SignalKServerSettingsFromJson(
  ...
  usePlugin: json['usePlugin'] as bool? ?? true,
  ...
  realTimeDataTimeout: (json['realTimeDataTimeout'] as num?)?.toInt() ?? 10000,
  ...
  supplementalGroupIDs:
      (json['supplementalGroupIDs'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toSet() ??
      const {},
...
_Settings _$SettingsFromJson(Map<String, dynamic> json) => _Settings(
  ...
  quickPageSwitch: json['quickPageSwitch'] as bool? ?? false,
  ...
  enableExperimentalBoxes: json['enableExperimentalBoxes'] as bool? ?? false,
  ...
  airPressureUnits:
      $enumDecodeNullable(
        _$AirPressureUnitsEnumMap,
        json['airPressureUnits'],
      ) ??
      AirPressureUnits.millibar,
  oilPressureUnits:
      $enumDecodeNullable(
        _$OilPressureUnitsEnumMap,
        json['oilPressureUnits'],
      ) ??
  ...
  capacityUnits:
      ...
      CapacityUnits.liter,
  fluidRateUnits:
      $enumDecodeNullable(_$FluidRateUnitsEnumMap, json['fluidRateUnits']) ??
      FluidRateUnits.litersPerHour,
  portStarboardColors:
      $enumDecodeNullable(
        _$PortStarboardColorsEnumMap,
        json['portStarboardColors'],
      ) ??
...
BackgroundDataSettings _$BackgroundDataSettingsFromJson(
  ...
  dataDuration:
      $enumDecodeNullable(
        _$BackgroundDataDurationEnumMap,
        json['dataDuration'],
      ) ??
